...
project["day"] = project["project_submitted_datetime"].dt.day
project["hour"] = project["project_submitted_datetime"].dt.hour
...
le = LabelEncoder()
project["teacher_id"] = le.fit_transform(project["teacher_id"])
...
temp = vectorizer.fit_transform(project)

from scipy.sparse import csr_matrix, hstack
final_dataset=temp.tocsr()
